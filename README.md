...
[![pub package](https://img.shields.io/pub/v/flutter_enhanced_barcode_scanner.svg)](https://pub.dartlang.org/packages/flutter_barcode_scanner)
...
dependencies:
  ...
  flutter_enhanced_barcode_scanner: ^3.0.1
```
