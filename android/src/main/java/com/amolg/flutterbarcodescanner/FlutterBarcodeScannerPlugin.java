...
public class FlutterBarcodeScannerPlugin implements MethodCallHandler, ActivityResultListener, StreamHandler, FlutterPlugin, ActivityAware {
    private static final String CHANNEL = "flutter_enhanced_barcode_scanner";
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        try {
            ...
            if (call.method.equals("scanBarcode")) {
                ...
                isFrontCamera = (boolean) arguments.get("isFrontCamera");
    ...
    private void createPluginSetup(
        ...
        eventChannel =
                new EventChannel(messenger, "flutter_enhanced_barcode_scanner_receiver");
